                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <a href="handle_add_reaction_from_post_details.php?postId=<?= $post['id'] ?>" class="" style="text-decoration: none;">
                                            ...
                                            <div>
                                                <a href="handle_delete_reaction_from_post_details.php?postId=<?= $post['id'] ?>" class="" style="text-decoration: none;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="deletepost.php?postId=<?= $post['id'] ?>" class="btn btn-sm btn-outline-secondary">Delete</a>

                                            <a href="edit_post.php?postId=<?= $post['id'] ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
                                        ...
                                        <div class="">
                                            <div class="card-body d-flex justify-content-between">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <a href="handle_delete_comment.php?postId=<?= $comment['id'] ?>" class="btn btn-sm btn-info">Delete</a>
                                                        <a href="edit_comment.php?postId=<?= $post['id'] ?>&commentId=<?= $comment['id'] ?>" class="btn btn-sm btn-info">Edit</a>
                                ...
                                ?>
                                <hr>
                                <form id="addPostForm" action="handleaddcomment.php" method="POST">
