                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    ...
                                                    <a href="handle_add_reaction_from_post.php?postId=<?= $post['id'] ?>" class="me-5" style="text-decoration: none;">
                                                ...
                                                <div>
                                                    <a href="handle_delete_reaction_from_post.php?postId=<?= $post['id'] ?>" class="" style="text-decoration: none;">
                                                        <span class="material-symbols-outlined">
                                                            thumb_down
                                                        </span>
                                                    </a>
