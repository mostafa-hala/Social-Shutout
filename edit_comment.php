...
if (isset($_GET['postId']) && isset($_GET['commentId'])) {
    $comments = $user->showcommentdetails($_GET['commentId']);
    // Rest of the code
    // var_dump($comments);
...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300&family=Mea+Culpa&family=Pacifico&family=Roboto+Condensed&family=Yesteryear&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Welcome <?php
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">WELCOME /h5>
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="user_view_posts.php">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="user_view_post.php">
                                    <svg class="bi">
                                        <use xlink:href="#cart" />
                                    </svg>
                                    VIEW MY POSTS
            ...
            <?php
            if (!empty($_GET["msg"]) && $_GET["msg"] == "empty_title_content") {
            ?>
                    ...
                    <form id="addPostForm" action="" method="POST" enctype="multipart/form-data">
                        <div class="container mt-3" style="height: 100vh;">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <h2 class="addpost">EDIT POST</h2>
                                        <?php
                                        if (!empty($_GET["msg"]) && $_GET["msg"] == "done") {
                                        ?>
                                            <div class="alert alert-primary" role="alert">
                                                <strong>The Post Edited Successfully</strong>
                                            </div>
                                        <?php
                                        } elseif (!empty($_GET["msg"]) && $_GET["msg"] == "empty_title_content") {
                                            $id=$_GET["id"];
                                        ?>
                                            <div class="alert alert-danger" role="alert">
                                                <strong>Empty title and content, please fill them</strong>
                                            </div>
                                        <?php }
                                        ?>
                                        <hr>
                                    ...
                                    <div class="mb-3">
                                        <!-- <label for="exampleFormControlInput1" class="form-label"  >Image</label> -->
                                        <input type="hidden" class="form-control" name="id" id="exampleFormControlInput1" onchange="previewImage(event)" value=" <?= $id?>">
                                        <div id="imagePreview"></div>
                                    </div>
                                    <div class="mb-3">
            ...
            <?php } else {?>
                        ...
                        <div class="col-md-6 mt-5">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                ...
                                <div class="col-auto d-none d-lg-block">
                                    <img src="<?= $post['image'] ?>" width="200" height="250" alt="">
                ...
                <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text>
                    ...
                    ?>
                    <div class="col-md-6">
                        <form id="addPostForm"  action="handle_edit_comment.php" method="POST" enctype="multipart/form-data">
                            <div class="container mt-3" style="height: 100vh;">
                                <div class="row">

                                    <div class="col-12">
                                        <div class="mb-3">
                                            <h2 class="addpost">EDIT COMMENT</h2>
                                        ...
                                        <div class="mb-3">
                                            <!-- <label for="exampleFormControlInput1" class="form-label"  >Image</label> -->
                                            <input type="hidden" class="form-control" name="idpost" id="exampleFormControlInput1" onchange="previewImage(event)" value=" <?= $_GET['postId'] ?>">
                                            <div id="imagePreview"></div>
                                        </div>
                                        <div class="mb-3">
                                            <!-- <label for="exampleFormControlInput1" class="form-label"  >Image</label> -->
                                            <input type="hidden" class="form-control" name="idcomment" id="exampleFormControlInput1" onchange="previewImage(event)" value=" <?= $_GET['commentId'] ?>">
                                            <div id="imagePreview"></div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">Content</label>
