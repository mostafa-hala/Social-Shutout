...
// var_dump($number);
$counts = $user->showAllUsers();
// var_dump($counts["email"]);
// for ($i=0; $i <sizeof($count) ; $i++) { 
//     // var_dump($count[$i]["username"]);
                ...
                <div class="d-flex text-body-secondary pt-3">
                    ...
                    <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
                        <div class="d-flex justify-content-between">
                            <strong class="text-gray-dark"><?= $count["username"]?></strong>
                            <div class="d-flex">

                                <a href="view_user_from_admin.php?userId=<?= $count['id'] ?>" class="me-2">View</a>
                                <a href="Delete_user.php?userId=<?= $count['id'] ?>" class="me-2">Delete</a>
                                <a href="update_to_admin.php?userId=<?= $count['id'] ?>">Admin</a>

                            </div>
                        </div>
                        <span class="d-block">@<?=$count["role"]?></span>
                    </div>
                </div>
            <?php
            }
